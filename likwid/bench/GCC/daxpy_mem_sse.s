...
vmovntps [rdx + rax*8], xmm0
vmovntps [rdx + rax*8+16], xmm1
vmovntps [rdx + rax*8+32], xmm2
vmovntps [rdx + rax*8+48], xmm3
addq rax, 8
cmpq rax, rdi
jl 1b
...
pop rbp
ret
.size daxpy_mem_sse, .-daxpy_mem_sse
