...
static const TestCase kernels[NUMKERNELS] = {
    ...
    {"daxpy_mem_avx" , STREAM_2, DOUBLE, 24, &daxpy_mem_avx, 2, 24, "Double-precision linear combination of two vectors, optimized for AVX and non-temporal stores", 2, 1, -1, 17, 21, 38},
    
    {"daxpy_mem_avx_fma" , STREAM_2, DOUBLE, 16, &daxpy_mem_avx_fma, 2, 24, "Double-precision linear combination of two vectors, optimized for AVX FMAs and non-temporal stores", 2, 1, -1, 17, 15, 22},
    
    {"daxpy_mem_sse" , STREAM_2, DOUBLE, 8, &daxpy_mem_sse, 2, 24, "Double-precision linear combination of two vectors, optimized for SSE and non-temporal stores", 2, 1, -1, 17, 15, 26},
    
    {"daxpy_mem_sse_fma" , STREAM_2, DOUBLE, 8, &daxpy_mem_sse_fma, 2, 24, "Double-precision linear combination of two vectors, optimized for SSE FMAs and non temporal stores", 2, 1, -1, 17, 15, 22},
    ...
    {"daxpy_sp_avx_fma" , STREAM_2, SINGLE, 16, &daxpy_sp_avx_fma, 2, 12, "Single-precision linear combination of two vectors, optimized for AVX FMAs", 2, 1, -1, 17, 15, 22},
    
    {"daxpy_sp_mem_avx" , STREAM_2, SINGLE, 16, &daxpy_sp_mem_avx, 2, 12, "Single-precision linear combination of two vectors, optimized for AVX and non-temporal stores", 2, 1, -1, 17, 9, 14},
    
    {"daxpy_sp_mem_avx_fma" , STREAM_2, SINGLE, 16, &daxpy_sp_mem_avx_fma, 2, 12, "Single-precision linear combination of two vectors, optimized for AVX FMAs and non-temporal stores", 2, 1, -1, 17, 15, 22},
    
    {"daxpy_sp_mem_sse" , STREAM_2, SINGLE, 8, &daxpy_sp_mem_sse, 2, 12, "Single-precision linear combination of two vectors, optimized for SSE and non-temporal stores", 2, 1, -1, 17, 11, 14},
    
    {"daxpy_sp_mem_sse_fma" , STREAM_2, SINGLE, 32, &daxpy_sp_mem_sse_fma, 2, 12, "Single-precision linear combination of two vectors, optimized for SSE FMAs and non-temporal stores", 2, 1, -1, 17, 15, 22},
