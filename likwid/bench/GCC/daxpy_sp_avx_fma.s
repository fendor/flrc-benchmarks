...
.text
.globl daxpy_sp_avx_fma
.type daxpy_sp_avx_fma, @function
daxpy_sp_avx_fma :
push rbp
mov rbp, rsp
push rbx
...
vmovaps [rdx + rax*4+32], ymm2
vmovaps [rdx + rax*4+64], ymm3
vmovaps [rdx + rax*4+96], ymm4
addq rax, 16
cmpq rax, rdi
jl 1b
...
pop rbp
ret
.size daxpy_sp_avx_fma, .-daxpy_sp_avx_fma
